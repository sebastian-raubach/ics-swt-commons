...
/**
 * {@link I18nDialog} extends {@link Dialog}. It overrides
 * {@link #createButton(Composite, int, String, boolean)} and replaces the
 * default English label with the internationalized version. Labels that are
 * different to the ones defined in {@link IDialogConstants} won't be changed.
 * 
