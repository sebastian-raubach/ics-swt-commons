...
/**
 * {@link CollectionUtils} contains methods to manipulate/check
 * {@link Collection}s and certain sub-classes in particular.
 * 
...
{
    /**
     * Joins the given input {@link Collection} with the given delimiter into a
     * String
     * 
     * @param input
    ...
    public static <T> String joinList(Collection<T> input, String delimiter)
    {
        ...
        while (it.hasNext())
        {
            builder.append(delimiter + it.next());
        }
    ...
    /**
     * Checks if the given {@link Collection} is either <code>null</code> or
     * empty.
     * 
     * @param input
     *            The {@link Collection} to check
     * @return <code>true</code> if either <code>input == null</code> or
     *         <code>input.size() < 1</code>
     */
    ...
    /**
     * Creates a {@link List} from the given input {@link String} by first
     * splitting it on the given splitter
     * 
     * @param input
